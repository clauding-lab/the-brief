...
[![Version](https://img.shields.io/badge/version-1.5.0-a67c2e?style=flat-square)](./CHANGELOG.md)
...
See [CHANGELOG.md](./CHANGELOG.md) for the full release history. Current: **v1.5.0**.
