...
- **Change one, change the other.** Retune the Editor's voice without the Sub-Editor and the Sub-Editor flattens it back out on its revise pass. §7 enforces the same five rules the Editor writes to (sentences-not-telegrams, mechanism in ordinary words, facts-carry-judgment, today's-sentences, institutional neutrality) and bans humour outright; §12's blocklist (delve/myriad/robust/amid/moreover…) is LLM-slop and stays.
